...
|
*/
//$config['base_url']	= 'http://groupfund.me/taskrobo/';
...
if(file_exists($config['base_path'].'.htaccess'))
{
	...
	else
	{
		...
		{ 
			 $show_cc = file_get_contents($config['base_url']."check_rewrite.php");
...
|
*/
$config['subclass_prefix'] = 'ROCKERS_';
...
|
*/
$config['encryption_key'] = 'dgg45gr6rgre7ew45r';
